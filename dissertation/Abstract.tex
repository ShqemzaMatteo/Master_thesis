\begin{abstract}
    ...
    Finally, we introduce Kullback-Leibler and Jensen-Shannon divergences based on network entropy, which define a distance metric between networks according to their relaxation behavior. However, these measures rely solely on the network spectrum and thus cannot distinguish between different networks with the same spectral properties. 
